      ...
      <div class="mobile-header p-4">
        <div class="mobile-greeting">
          ...
          <p class="mobile-balance text-lg text-gray-600">
            Balance: <span class="amount positive text-green-600 font-semibold">${{ formatCurrency(dashboardStore.totalBalance) }}</span>
          </p>
        </div>
      </div>
      ...
      <div class="mobile-sections px-4 pb-20">
          ...
          <div class="mobile-expenses space-y-3">
            <div v-for="expense in recentExpenses" :key="expense.id" 
              ...
              <div class="flex items-center">
                <div class="expense-icon w-10 h-10 rounded-full flex items-center justify-center mr-3"
                ...
                <div class="expense-amount font-semibold text-red-600">
        ...
        <div class="mobile-section mb-6" v-if="budgetStore.currentBudgets.length">
          ...
          <div class="mobile-budgets space-y-3">
            <div v-for="budget in budgetStore.currentBudgets.slice(0, 3)" :key="budget.id" 
        ...
        <div class="mobile-actions">
          <div class="grid grid-cols-2 gap-4">
            <button v-for="action in mobileQuickActions" :key="action.id" 
              class="action-card bg-white rounded-xl p-4 shadow-sm border border-gray-100 flex items-center"
              @click="handleQuickAction(action.id)">
              <div class="action-icon w-10 h-10 rounded-full flex items-center justify-center mr-3"
      ...
      <main class="flex-1 py-6 px-4">
        <div class="max-w-7xl mx-auto">
          ...
          <div class="mb-12 relative overflow-hidden">
            ...
            <div class="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-blue-400/20 to-purple-400/20 rounded-full filter blur-3xl animate-pulse"></div>
            <div class="absolute bottom-0 left-0 w-48 h-48 bg-gradient-to-tr from-purple-400/20 to-pink-400/20 rounded-full filter blur-2xl animation-delay-1000 animate-pulse"></div>
              ...
              <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                ...
                <div class="flex-1">
                  <div class="flex items-center gap-4 mb-4">
                    <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-xl shadow-blue-500/25">
                      <i class="fas fa-chart-pie text-white text-2xl"></i>
                    </div>
                    <div>
                      <h1 class="text-4xl font-bold bg-gradient-to-r from-gray-900 via-blue-800 to-purple-800 bg-clip-text text-transparent leading-tight">
                        Welcome Back!
                      </h1>
                  ...
                  <div class="flex flex-wrap gap-4 mt-6">
                    <div class="flex items-center gap-2 px-4 py-2 bg-white/50 backdrop-blur-sm rounded-full border border-white/30">
                ...
                <div class="flex flex-col gap-3 lg:flex-row lg:gap-4">
                  ...
                  <button 
                    @click="showSettings"
                    class="modern-action-btn outline"
...
const getTotalExpenses = () => {
  ...
  console.log('Debug - Expenses for total calculation:', expenses.slice(0, 3)) // Log first 3 for debugging
      ...
      if (window.notify) {
        ...
        setTimeout(() => {
          if (window.notify && typeof window.notify.showExpenseAdded === 'function') {
            window.notify.showExpenseAdded(12.50, 'Coffee')
          }
        }, 6000)
      }
    }, 1000)
