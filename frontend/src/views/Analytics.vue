            ...
            <div class="flex justify-between items-start">
              <div class="flex-1">
                ...
                <p class="text-gray-600 text-lg leading-relaxed max-w-2xl">
                  Get comprehensive insights into your spending patterns, financial health, and personalized recommendations to improve your financial wellbeing.
                </p>
              </div>
                ...
                <div class="chart-container trend-analysis">
                  <div class="chart-header">
                    ...
                    <div class="chart-controls">
                      <select v-model="trendViewType" class="view-selector" :class="{ 'mobile-optimized': isMobile }">
          ...
          <div class="comparison-section" data-section="comparison">
            <div class="comparison-header">
              ...
              <div class="comparison-controls">
                <select v-model="comparisonType" class="comparison-selector" :class="{ 'mobile-optimized': isMobile }">
...
export default {
  ...
  setup() {
    ...
    const monthlyForecast = computed(() => 3590.50)
