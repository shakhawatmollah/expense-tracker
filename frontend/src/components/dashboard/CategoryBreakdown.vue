      ...
      <div v-if="chartData && displayedCategories.length > 0" class="legend-section">
        <div class="legend-header">
          ...
          <div class="view-toggle">
            <button
              ...
              :class="['toggle-btn', { active: viewMode === 'percentage' }]"
            >
              %
            </button>
            <button
              @click="viewMode = 'amount'"
              :class="['toggle-btn', { active: viewMode === 'amount' }]"
            >
              $
            </button>
          </div>
        ...
        <div v-if="categoryData.length > displayedCategories.length" class="show-more">
          <button @click="showAllCategories = !showAllCategories" class="show-more-btn">
            <span>{{ showAllCategories ? 'Show Less' : `Show ${categoryData.length - displayedCategories.length} More` }}</span>
...
.donut-segment:nth-child(1) { transform: rotate(0deg); }
.donut-segment:nth-child(2) { transform: rotate(45deg); }
.donut-segment:nth-child(3) { transform: rotate(90deg); }
.donut-segment:nth-child(4) { transform: rotate(135deg); }
.donut-segment:nth-child(5) { transform: rotate(180deg); }
.donut-segment:nth-child(6) { transform: rotate(225deg); }
.donut-segment:nth-child(7) { transform: rotate(270deg); }
.donut-segment:nth-child(8) { transform: rotate(315deg); }
