<template>
  <div class="p-4 border rounded">
    ...
    <div class="mt-4 space-y-2">
      <button @click="testAuth" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">Test Auth</button>
      <button @click="testTrends" class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600">
        Test Trends API
      </button>
