      ...
      <div class="header-content">
        ...
        <div class="header-actions">
          ...
          >
            ...
            <div v-if="showDropdown" class="dropdown-menu" @click.stop role="menu" aria-label="User profile options">
...
<script setup>
  ...
  const closeDropdown = event => {
    ...
    if (!event.target.closest('.user-profile') && !event.target.closest('.notifications-container')) {
      showDropdown.value = false
      showNotifications.value = false
    }
  }
