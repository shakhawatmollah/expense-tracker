      ...
      <div class="quick-add-modal" @click.stop>
        ...
        <form @submit.prevent="submitExpense" class="modal-content">
          ...
          <div class="form-group">
            ...
            <select id="category" v-model="form.category_id" class="form-select" required>
    ...
    try {
      ...
      if (window.notify) {
        window.notify.success(
          'Expense Added!',
          `$${expenseData.amount} expense for ${expenseData.description} has been added successfully`
        )
      }
