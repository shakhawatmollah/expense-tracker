...
const props = defineProps({
  type: {
    ...
    default: 'fade',
    validator: (value) => [
      'fade', 'slide', 'slide-up', 'slide-down', 'slide-left', 'slide-right',
      'zoom', 'flip', 'bounce', 'elastic', 'scale', 'rotate', 'blur'
    ].includes(value)
  },
  mode: {
    type: String,
...
.bounce-leave-active {
  animation: bounce-out v-bind('typeof duration === "number" ? duration + "ms" : duration.leave + "ms"') v-bind(easing);
}
...
/* Elastic Transition */
.elastic-enter-active {
  animation: elastic-in v-bind('typeof duration === "number" ? duration + "ms" : duration.enter + "ms"') v-bind(easing);
}

.elastic-leave-active {
  animation: elastic-out v-bind('typeof duration === "number" ? duration + "ms" : duration.leave + "ms"') v-bind(easing);
}
...
.zoom-group-move,
.scale-group-move {
  transition: transform v-bind('typeof duration === "number" ? duration + "ms" : duration.enter + "ms"') v-bind(easing);
}
