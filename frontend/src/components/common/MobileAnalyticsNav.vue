  ...
  <div class="mobile-analytics-nav" :class="{ 'sticky': isSticky, 'collapsed': isCollapsed }">
    ...
    <div class="nav-content" v-show="!isCollapsed">
      ...
      <div class="quick-actions">
        ...
        <button 
          @click="$emit('export')"
          class="quick-action-btn export-btn"
        ...
        <button 
          @click="$emit('share')"
          class="quick-action-btn share-btn"
      ...
      <div class="filter-options" v-if="showFilters">
        ...
        <div class="filter-controls">
          <select v-model="categoryFilter" @change="$emit('filter-change', 'category', categoryFilter)" class="filter-select">
      ...
      <div class="view-options">
        ...
        <div class="view-toggles">
          ...
          <button 
            :class="['view-toggle', { active: viewMode === 'compact' }]"
            @click="$emit('view-change', 'compact')"
          >
            <i class="fas fa-th"></i>
            <span>Compact</span>
          </button>
  ...
  setup(props, { emit }) {
    ...
    const handleScroll = () => {
      ...
      const sectionElements = sections.value.map(section => ({
        id: section.id,
        element: document.querySelector(`[data-section="${section.id}"]`) || 
