    ...
    <div class="error-container">
      ...
      <div class="error-content">
        ...
        <div class="error-details" v-if="showDetails && details">
          <button @click="toggleDetails" class="details-toggle" :class="{ expanded: detailsExpanded }">
      ...
      <div class="error-actions" v-if="showActions">
        <button v-if="showRetry" @click="$emit('retry')" class="action-btn primary" :disabled="retrying">
          <i class="fas fa-redo-alt" :class="{ 'fa-spin': retrying }"></i>
          {{ retrying ? 'Retrying...' : 'Try Again' }}
        </button>

        <button v-if="showRefresh" @click="$emit('refresh')" class="action-btn secondary">
          <i class="fas fa-sync-alt"></i>
          Refresh Page
        </button>

        <button v-if="showContact" @click="$emit('contact')" class="action-btn tertiary">
          <i class="fas fa-envelope"></i>
          Contact Support
        </button>

        <router-link v-if="showHome" to="/" class="action-btn secondary">
...
<script setup>
  ...
  const props = defineProps({
    type: {
      ...
      default: 'general',
      validator: value =>
        ['general', 'network', 'permission', 'not-found', 'server', 'validation', 'timeout'].includes(value)
    },
    variant: {
      type: String,
      default: 'default',
