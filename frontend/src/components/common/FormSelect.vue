  ...
  <div class="form-field" :class="{ 'has-error': hasError, 'is-focused': isFocused, 'has-value': hasValue }">
    <div class="select-container">
      ...
      >
        ...
        <!-- Floating Label -->
        <label v-if="floatingLabel && label" :for="selectId" class="floating-label" :class="labelClasses">
          {{ label }}
      ...
      <!-- Dropdown Menu -->
      <div v-if="isOpen" class="dropdown-menu" :class="dropdownClasses" role="listbox">
    ...
    <!-- Traditional Label -->
    <label v-if="!floatingLabel && label" :for="selectId" class="traditional-label">
      {{ label }}
      <span v-if="required" class="required-asterisk">*</span>
    </label>
...
<script setup>
  ...
  const selectedOption = computed(() => {
    ...
    if (props.multiple) {
      return props.options.filter(option => props.modelValue.includes(getOptionValue(option)))
    }
  ...
  const filteredOptions = computed(() => {
    ...
    return props.options.filter(
      option =>
        ...
        (option[props.optionDescription] && option[props.optionDescription].toLowerCase().includes(query))
    )
  })
  ...
  const getOptionKey = (option, index) => {
    return typeof option === 'object' ? option.id || option[props.optionValue] || index : option
  }
