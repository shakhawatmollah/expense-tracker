<template>
  <Teleport to="body">
    ...
    <!-- Notification Center -->
    <div v-if="showNotificationCenter" class="notification-center" :class="{ mobile: isMobile }">
      ...
      <div class="notification-center-content">
        ...
        <div v-else class="notifications-history">
          ...
          >
            ...
            <button @click.stop="removeFromHistory(notification.id)" class="history-remove">
              <i class="fas fa-times"></i>
            </button>
          </div>
        </div>
    ...
    <div v-if="showNotificationCenter" @click="closeNotificationCenter" class="notification-center-overlay"></div>
  </Teleport>
</template>
...
<script>
  ...
  export default {
    ...
    setup(props, { emit }) {
      ...
      const hasUnreadNotifications = computed(() => allNotifications.value.some(n => !n.read))
