<template>
  <div class="space-y-6">
          ...
          <div class="flex items-start justify-between">
            <div class="flex items-center space-x-3 flex-1">
              ...
              <div class="flex-1 min-w-0">
                ...
                <p class="text-xs text-gray-400 mt-1">{{ category.expenses_count || 0 }} expenses</p>
              </div>
            </div>
            <div class="flex space-x-1">
              <button @click="openEditModal(category)" class="p-1 text-gray-400 hover:text-gray-600 rounded">
    ...
    <!-- Category Form Modal -->
    <CategoryForm :is-open="showForm" :category="selectedCategory" @close="closeModal" @saved="handleCategorySaved" />
