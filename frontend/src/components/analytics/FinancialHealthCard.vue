  ...
  <div class="bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden">
      ...
      <div class="bg-red-50 border border-red-200 rounded-md p-4">
        <div class="flex">
          ...
          <div class="ml-3">
            ...
            <button 
              @click="retryLoad"
              class="mt-2 bg-red-100 hover:bg-red-200 text-red-800 text-sm px-3 py-1 rounded"
            >
              Try Again
            </button>
          </div>
    ...
    <div v-else-if="financialHealth" class="p-6">
      ...
      <div class="mt-6 pt-4 border-t border-gray-200 flex items-center justify-between text-xs text-gray-500">
        ...
        >
          <svg class="w-4 h-4 inline-block mr-1" :class="{ 'animate-spin': refreshing }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
