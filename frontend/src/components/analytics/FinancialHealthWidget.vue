        ...
        <div class="component-scores">
          <div class="score-item">
            <div class="score-item-header">
              ...
              <span class="score-item-value">{{ Math.round(healthData.data.current.expense_control_score) }}%</span>
            </div>
            <div class="score-bar">
              <div
          ...
          <div class="score-item">
            <div class="score-item-header">
              ...
              <span class="score-item-value">{{ Math.round(healthData.data.current.budget_adherence_score) }}%</span>
            </div>
            <div class="score-bar">
              <div
                class="score-bar-fill"
          ...
          <div class="score-item">
            <div class="score-item-header">
              ...
              <span class="score-item-value">{{ Math.round(healthData.data.current.savings_rate_score) }}%</span>
            </div>
            <div class="score-bar">
              <div
                class="score-bar-fill"
          ...
          <div class="score-item">
            <div class="score-item-header">
              ...
              <span class="score-item-value">{{ Math.round(healthData.data.current.debt_ratio_score) }}%</span>
            </div>
            <div class="score-bar">
              <div
                class="score-bar-fill"
