      ...
      <div class="trends-container">
              ...
              <div class="trend-line-chart">
                ...
                <div class="trend-path">
                  ...
                  <svg class="trend-svg" viewBox="0 0 100 100" preserveAspectRatio="none">
                    <polyline fill="none" stroke="#007bff" stroke-width="2" :points="trendPolylinePoints" />
                  </svg>
                </div>
              </div>
        ...
        <div class="category-trends" v-if="selectedMetric === 'categories'">
          ...
          <div class="category-chart">
            <div v-for="category in topCategories" :key="category.name" class="category-bar-item">
              ...
              <div class="category-trend">
                <span :class="['trend-indicator', category.trend > 0 ? 'increasing' : 'decreasing']">
...
<script>
  export default {
    ...
    computed: {
      ...
      trendPolylinePoints() {
        return this.mockTrendData.map((point, index) => `${index * 8.33},${100 - point}`).join(' ')
      },
      maxCategoryAmount() {
