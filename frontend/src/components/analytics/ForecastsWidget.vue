      ...
      <div class="forecasts-container">
        ...
        <div class="forecast-section" v-if="forecasts.next_month_forecast">
          ...
          <div class="forecast-card">
            <div class="forecast-value">${{ formatCurrency(forecasts.next_month_forecast) }}</div>
          ...
          <div class="category-forecasts">
            ...
            >
              ...
              <div class="category-change" v-if="categoryForecast.change">
                <span :class="['change-indicator', categoryForecast.change > 0 ? 'increase' : 'decrease']">
                  <i :class="['fas', categoryForecast.change > 0 ? 'fa-arrow-up' : 'fa-arrow-down']"></i>
          ...
          <div class="trend-analysis">
            <div class="trend-card">
              <div class="trend-header">
                ...
                <span :class="['trend-badge', getTrendClass(forecasts.trend_analysis.overall_trend)]">
              ...
              <div class="trend-details" v-if="forecasts.trend_analysis.trend_percentage">
                <div class="trend-chart">
                  ...
                  <span class="trend-percentage">{{ Math.abs(forecasts.trend_analysis.trend_percentage) }}%</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="forecast-section">
          ...
          <div class="confidence-meter">
            ...
            <div class="confidence-label">{{ forecastConfidence }}% Confidence</div>
            <small class="confidence-note">Based on {{ historicalDataPoints }} months of spending data</small>
          </div>
        </div>
      </div>
    </template>
