  ...
  <div class="insights-widget">
    ...
    <template v-else-if="insights && insights.length > 0">
      <div class="insights-list">
        <div v-for="insight in insights.slice(0, 5)" :key="insight.id" class="insight-item">
                ...
                <div class="trends-info">
                  ...
                  <div class="trend-indicator">
                    <i
                      :class="[
                        'trend-icon',
                        insight.insight_data.trends.trend_direction === 'increasing'
                  ...
                  <div class="performance-grid">
                    ...
                    >
                      <div class="performance-header">
                        ...
                        <span class="utilization-badge" :class="getUtilizationClass(budget.utilization)">
            ...
            <template v-if="insight.action_items && insight.action_items.length > 0">
              <div class="action-items">
                ...
                <ul class="action-list">
                  <li v-for="action in insight.action_items.slice(0, 2)" :key="action" class="action-item">
      ...
      <div class="view-all" v-if="insights.length > 5">
        <button class="btn btn-outline-primary btn-sm">View All Insights ({{ insights.length }})</button>
      </div>
    </template>
