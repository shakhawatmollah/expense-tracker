  ...
  <div class="budget-summary-widget">
    ...
    <div v-else class="widget-content">
      ...
      <div class="summary-stats">
        <div class="stat-card total-budget">
          ...
          <div class="stat-content">
            <AnimatedCounter 
              :value="budgetStore.totalBudgetAmount" 
              :duration="1000"
              prefix="$"
              class="stat-value"
            />
        ...
        <div class="stat-card total-spent">
          ...
          <div class="stat-content">
            <AnimatedCounter 
              :value="budgetStore.totalSpentAmount" 
              :duration="1200"
              prefix="$"
              class="stat-value"
            />
      ...
      <div v-else class="enhanced-empty-state">
        ...
        <p class="empty-description">Create your first budget to start tracking spending and achieve your financial goals</p>
