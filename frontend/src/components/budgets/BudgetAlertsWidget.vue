  ...
  <div class="budget-alerts-widget">
    ...
    <div class="widget-header">
      ...
      <div class="header-right">
        <button @click="refreshAlerts" class="refresh-btn" :disabled="budgetStore.isLoading">
      ...
      <div v-if="displayAlerts.length > 0" class="alert-list">
        ...
        >
          ...
          <div class="alert-actions">
            <button @click="viewBudgetDetails(alert.budget_id)" class="action-btn" title="View Budget">
              <i class="fas fa-eye"></i>
            </button>
            <button @click="dismissAlert(alert)" class="action-btn" title="Dismiss Alert">
  ...
  export default {
    ...
    setup() {
      ...
      const refreshAlerts = async () => {
        try {
          await Promise.all([budgetStore.fetchBudgetAlerts(), budgetStore.fetchCurrentBudgets()])
        } catch (error) {
      ...
      const dismissAlert = alert => {
        ...
        const index = budgetStore.budgetAlerts.findIndex(
          a => a.budget_id === alert.budget_id && a.level === alert.level
        )
        if (index !== -1) {
