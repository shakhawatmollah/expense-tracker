  ...
  { value: 'yearly', label: 'Yearly' }
    ...
    const initializeForm = () => {
      ...
      if (props.isEditing && props.budget) {
        ...
        console.log('🗓️ Processing dates after normalization fix:', {
          ...
          all_budget_props: Object.keys(props.budget).filter(key => 
            key.includes('date') || key.includes('start') || key.includes('end') || key.includes('period')
          )
        })
    ...
    watch(() => props.budget, (newBudget, oldBudget) => {
    ...
    watch(() => props.isEditing, (isEditing, wasEditing) => {
