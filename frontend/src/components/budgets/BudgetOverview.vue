  ...
  <div class="budget-overview">
    ...
    <div class="overview-header">
      <div class="header-content">
        ...
        <p class="page-subtitle">
          Track, manage, and optimize your spending budgets
        </p>
      </div>
      ...
      <div class="header-actions">
        ...
        <button 
          ...
          class="btn btn-primary create-budget-btn"
        >
    ...
    <div class="quick-actions-section">
      ...
      <div class="actions-grid">
        ...
        <button 
          @click="showBudgetAnalytics = true" 
          class="action-card"
        >
          <div class="action-icon">
    ...
    <div class="categories-section">
      ...
      <div v-if="viewMode === 'grid'" class="categories-grid">
        <div 
          v-for="(budgets, categoryName) in budgetStore.budgetsByCategory" 
          :key="categoryName"
          class="category-card"
        >
          ...
          <div class="category-actions">
            <button 
              @click="viewCategoryBudgets(categoryName)" 
              class="btn btn-sm btn-outline"
            >
              View Budgets
            </button>
    ...
    <BudgetAnalyticsModal
      v-if="showBudgetAnalytics"
      @close="showBudgetAnalytics = false"
    />
